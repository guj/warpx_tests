...
#SBATCH -N 12
# #SBATCH -o %x-%j.out
#SBATCH -o log.mpi4b.o%j
#SBATCH -e log.mpi4b.e%j
...
runMe()
{
    ...
    echo "now monitor ${MONITOR}  ${OUTPUT_DIR}/output.${key}_${aggDesc} diags/diag1 .sst ${SST_TRANSPORT} 4 2 2 1"
    pwd
    bash  ${MONITOR}  ${OUTPUT_DIR}/output.${key}_${aggDesc} diags/diag1 .sst ${SST_TRANSPORT} 4 "2 2 1"
    ## move to 
    #mv *.bp* diags/diag1
