...
runMe()
{
    ...
    export OPENPMD_ADIOS2_NUM_SUBSTREAMS=$3
    echo "export OPENPMD_ADIOS2_NUM_SUBSTREAMS=$3"
...
useConfig()
{
    ...
    INPUTS=${pwd}/../local_inputs/input.n${SLURM_NNODES}${ENC}.${key}
	...
	#mkdir /mnt/bb/junmin/diags
	#ln -s /mnt/bb/junmin/diags diags
	runMe EveryoneWritesSerial ews_rank   ${TOTAL_NMPI}
	#date
	#echo "moving data to disk from nvme"
	#mkdir hd_diags
	#mv  diags/* hd_diags
	date
    fi
